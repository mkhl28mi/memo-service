package io.github.mkhl28mi.memo_service.domain.admin.position.service;
...
import io.github.mkhl28mi.memo_service.domain.admin.position.repository.PositionRepository;
...
public class PositionService {
	...
	public Position getPositionById(UUID id) throws ResourceNotFoundException {
	...
	public PositionResponse getPositionResponseById(UUID id) throws ResourceNotFoundException {
	...
	@Transactional
	public PositionResponse updatePosition(UUID id, PositionRequest positionRequest) throws ResourceNotFoundException {
		Position position = positionRepository.findById(id)
        		.orElseThrow(() -> new ResourceNotFoundException("Position not found with id: " + id));
